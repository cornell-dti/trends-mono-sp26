...
let firstName: string = 'Esha';       // string type
...
console.log(greet(firstName));  // Outputs: Hello, Esha
...
// NOTE: interfaces are kind of similar, and are preferred when you want easy extension. 
// Typically, you want to choose one and stick with it within a codebase
